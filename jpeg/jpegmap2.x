...
//resource inter is ExegyDMA ({ proc, fpga },
                            ...
                            //debugWrites="no",
                            //dumpToCard="");
resource proc[3] is C {(file = "proc_1_.cpp", cpunum=0, xsim="false"), (file="proc_2_.cpp", cpunum=1,xsim="false"),(file="proc_3_.cpp",cpunum=2,xsim="false")};
